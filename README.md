...
Below is what the app looks like upon launch; the 5x5 is the default configuration, so
that is the one that is automatically displayed. The ninja can not leave the board, so
